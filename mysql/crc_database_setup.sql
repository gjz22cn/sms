...
CREATE TABLE `crc_bi` (
  ...
  `bi_cpos` int(4) NOT NULL default '0',
  `bi_psca` int(4) NOT NULL default '0',
  `bi_ppscore` int(4) NOT NULL default '0',
  `bi_edu` int(4) NOT NULL default '0',
  `bi_eduscore` int(4) NOT NULL default '0',
  `bi_cwy` int(4) NOT NULL default '0',
  `bi_wti` int(4) NOT NULL default '0',
  `bi_wtiscore` int(4) NOT NULL default '0',
  `bi_owy` int(4) NOT NULL default '0',
  `bi_eng` int(4) NOT NULL default '0',
  `bi_engscore` int(4) NOT NULL default '0',
  `bi_wyscore` int(4) NOT NULL default '0',
  `bi_bim` int(4) NOT NULL default '0',
  `bi_bimscore` int(4) NOT NULL default '0',
  `bi_cer` int(4) NOT NULL default '0',
  `bi_cer2` int(4) NOT NULL default '0',
...
CREATE TABLE `crc_workex` (
  ...
  `workex_position` int(4) NOT NULL default '0',
...
CREATE TABLE `crc_bidex` (
  ...
  `bidex_level` int(4) NOT NULL default '0',
  `bidex_position` int(4) NOT NULL default '0',
